...
//fix ywalls polymer wall/lj126 ylo 0.0 T_my[6] myseed[6] mygamma_C[6] mygamma_S[6] cutoff[6] myvx[6]
  int iarg = 3;
  while (iarg < narg) {
...
//fix ywalls polymer wall/lj126 ylo 0.0 T_my[6] myseed[6] mygamma_C[6] mygamma_S[6] cutoff[6] myvx[6]
      if (strstr(arg[iarg+2],"v_") == arg[iarg+2]) {
        ...
        T_my[nwall] = force->numeric(FLERR,arg[iarg+2]);
      ...
      if (strstr(arg[iarg+3],"v_") == arg[iarg+3]) {
        ...
        myseed[nwall] = force->numeric(FLERR,arg[iarg+3]);
        sstyle[nwall] = CONSTANT;
      }

      mygamma_C[nwall] = force->numeric(FLERR,arg[iarg+4]);
	  mygamma_S[nwall] = force->numeric(FLERR,arg[iarg+5]);
      cutoff[nwall] = force->numeric(FLERR,arg[iarg+6]);
      myvx_wall[nwall] = force->numeric(FLERR,arg[iarg+7]);
	  mya0[nwall] = force->numeric(FLERR,arg[iarg+8]);
      nwall++;
      iarg += 9;
...
FixWall::~FixWall()
{
  ...
  if (random11) delete random11;
  if (random12) delete random12;
  if (random13) delete random13;
  if (random21) delete random22;
  if (random22) delete random22;
  if (random23) delete random22;
  if (random31) delete random23;
  if (random32) delete random22;
  if (random33) delete random33;
}
