...
class FixWall : public Fix {
 ...
 protected:
  ...
  double T_my[6],myseed[6],mygamma_C[6],mygamma_S[6],myvx_wall[6],mya0[6];
  ...
  class RanMars *random11;
  class RanMars *random12;
  class RanMars *random13;
  class RanMars *random21;
  class RanMars *random22;
  class RanMars *random23;
  class RanMars *random31;
  class RanMars *random32;
  class RanMars *random33;
};
